...
<div class="container p-1 my-2 bg-dark text-white">
   <h2 style="text-align:center">EXAMINATION  RE-SITE/UPGRADING FORM FOR PROPER CANDIDATES</h2></div>
<form   method="POST"action="resit.php">
<label for="Registration_No" class="col-sm-3 col-form-label"> Registration No </label>
<input type="text"class="form-control col-s m-2 col-form-label" name="Registration_No" id="Registration_No"value="<?php echo $_SESSION['regNum']; ?>" required readonly>
