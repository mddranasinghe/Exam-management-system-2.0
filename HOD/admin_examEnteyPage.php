...
$HODNum=$_SESSION['regNum'];
$sql2 = "SELECT faculty FROM hod WHERE HODNum='$HODNum'";
...
$sql= "SELECT Registration_No,Name_with_initials,Name_of_the_examination  FROM examenrty WHERE faculty ='$faculty'AND year ='$year' AND semester='$semester'";
