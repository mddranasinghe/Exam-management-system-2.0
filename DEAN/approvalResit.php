...
if ($approval == 1) {
    $sql = "UPDATE approve_state_resit set $column=1 where Registration_No='$id' AND Name_of_the_examination='$name'";
} else {
    $sql = "UPDATE approve_state_resit set $column=0 where Registration_No='$id' AND Name_of_the_examination='$name'";
}
// echo $sql;
if (mysqli_query($conn, $sql)) {
    header("Location: ./viewResit.php?Registration_No=$id#table1");
} else {
