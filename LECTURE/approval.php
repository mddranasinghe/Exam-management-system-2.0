...
if ($approval == 1) {
    $sql = "UPDATE approve_state set $column=1 where Registration_No='$id' AND Name_of_the_examination='$name'";
} else {
    $sql = "UPDATE approve_state set $column=0 where Registration_No='$id' AND Name_of_the_examination='$name'";
}
// echo $sql;
