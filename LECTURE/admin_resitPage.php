	...
	<DIV class="wapper">
        <section class="sec">
                    ...
                    <div style="float:center;width:1200px;height:1250px;background-color:#white;margin-left:10px;margin-top:50px;"> <!-- margin left- eka wenas karahan -->
                        <div class ="box1">
                            <img src="images/Vavuniversity.jpg" style="float:center;">
                        </div>
			...
			<div class ="book_img">
						...
						<div class ="box3">
								...
								<h1 style ="text-align: center;font-size: 37px ; "> List of athe Resit   </h1>
								<br>
				...
				{
					$q=mysqli_query($conn,"SELECT *FROM resit where Registration_No like '%$_POST[search]%' ");
					...
					{
						$res=mysqli_query($conn,"SELECT * FROM resit ORDER BY resit.Registration_No ASC;");
							...
							echo "<table class='table table-bordered table-hover' >";
								echo "<tr style='background-color: white;color:red;'>";
                                    ...
                                    echo "<th>"; echo "Fees_Paid_for_examination";  echo "</th>";
                                    echo "<th>"; echo "amount";  echo "</th>";
                                    echo "<th>"; echo "date";  echo "</th>";
                                    echo "<th>"; echo "Receipt_No";  echo "</th>";
                                    echo "<th>"; echo "course_code_1";  echo "</th>";
                                    echo "<th>"; echo "subject_name_1";  echo "</th>";
                                    echo "<th>"; echo "Ast_attempt_1";  echo "</th>";
                                    echo "<th>"; echo "Bst_attempt_1";  echo "</th>";
                                    echo "<th>"; echo "Cst_attempt_1";  echo "</th>";
                                    echo "<th>"; echo "course_code_2";  echo "</th>";
                                    echo "<th>"; echo "subject_name_2";  echo "</th>";
                                    echo "<th>"; echo "Ast_attempt_2";  echo "</th>";
                                    echo "<th>"; echo "Bst_attempt_2";  echo "</th>";
                                    echo "<th>"; echo "Cst_attempt_2";  echo "</th>";
								echo "</tr>";	
								...
								while($row=mysqli_fetch_assoc($q))
								 {
                                    ...
                                    echo "<td>"; echo $row['Fees_Paid_for_examination']; echo "</td>";
                                    ...
                                    echo "<td>"; echo $row['Ast_attempt_1']; echo "</td>";
                                    echo "<td>"; echo $row['Bst_attempt_1']; echo "</td>";
                                    echo "<td>"; echo $row['Cst_attempt_1']; echo "</td>";
                                    echo "<td>"; echo $row['course_code_2']; echo "</td>";
                                    echo "<td>"; echo $row['subject_name_2']; echo "</td>";
                                    echo "<td>"; echo $row['Ast_attempt_2']; echo "</td>";
                                    echo "<td>"; echo $row['Bst_attempt_2']; echo "</td>";
                                    echo "<td>"; echo $row['Cst_attempt_2']; echo "</td>";
